...
import brocha from '../../assets/image/electicty.gif'
            ...
            <section className="w-full flex justify-center md:py-32 py-10">
                <div className="max-w-6xl md:flex md:p-0 px-2 content-reverse">
                    <div className="md:w-[50%]">
                        <div
                            className="w-full md:w-[600px] md:h-[600px] h-[400px] bg-cover bg-center rounded-3xl md:-ml-8 ml-0"
                            style={{ backgroundImage: `url("${image ? image : imgDefault}")` }}
                        ></div>
                        <div className='absolute borderColor border-[12px] lg:border-[16px] -mt-[20%] lg:-mt-[43%] lg:-ml-24 w-[80px] h-[80px] rounded-full lg:w-[300px] lg:h-[300px] -z-10 '></div>
                        <div className='absolute border-white shadow-2xl lg:border-[10px] -mt-[20%] lg:-mt-[14%]  w-[80px] h-[80px] lg:w-[300px] lg:h-[300px] bg-cover bg-center rounded-3xl'
